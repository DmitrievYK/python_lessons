...
k = 'laptop'
# 12
d_Eng = {'a': 1, 'e': 1, 'i': 1, 'o': 1, 'u': 1, 'l': 1, 'n': 1, 's': 1, 't': 1, 'r': 1,
 'd': 2, 'g': 2, 'b': 3, 'c': 3, 'm': 3, 'p': 3, 'f': 4, 'h': 4, 'v': 4, 'w': 4, 'y': 4,
 'k': 5, 'j': 8, 'x': 8, 'q': 10, 'z': 10}

d_Rus = {'а': 1, 'в': 1, 'е': 1, 'и': 1, 'н': 1, 'о': 1, 'р': 1, 'с': 1, 'т': 1, 'д': 2,
...
for letter in k.lower():
    #print(letter)

    if letter in d_Eng: # if letter in d_Eng.items():
        #for key, value in d_Eng.items():
        sum = sum + d_Eng[letter]

    elif letter in d_Rus: # elif letter in d_Rus.items():
        #for key, value in d_Rus.items():
        sum = sum + d_Rus[letter]
