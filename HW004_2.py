...
#         for i in range(3):
#             idx = (bush + i) % num_bushes
#             curr_harvest += arr[idx]

#         max_harvest = max(max_harvest, curr_harvest)

#     return max_harvest

# #arr = [5, 8, 6, 4, 9, 2, 7, 3] # Урожайность каждого куста
# #arr = [2, 4, 6, 8, 10] # 24
# #arr = [2, 4, 10, 4, 2] # 18
# arr = [10, 8, 6, 4, 2]


# max_harvest = max_berry_harvest(arr)
# print(max_harvest)
...
#         curr_harvest = 0
#         left_neighb = (i - 1) % num_bushes
#         right_neighb = (i + 1) % num_bushes

#         curr_harvest += arr[i] + arr[left_neighb] + arr[right_neighb]
#         max_harvest = max(max_harvest, curr_harvest)

#     return max_harvest


# arr = [2, 4, 10, 4, 2] # Урожайность каждого куста
# #arr = [2, 4, 6, 8, 10] # 24
